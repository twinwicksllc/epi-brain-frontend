...
export default function Dashboard() {
  ...
  return (
    <ProtectedRoute>
      <div className="flex h-screen bg-gradient-to-br from-[#1a0a2e] to-[#2d1b4e]">
        {/* Sidebar */}
        ...
        <div className="flex-1 flex flex-col">
          {/* Header */}
          <div className="bg-[#1a0a2e] border-b border-[#7B3FF2]/20 px-6 py-4 flex items-center justify-between">
