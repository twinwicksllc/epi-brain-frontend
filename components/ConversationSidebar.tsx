...
export default function ConversationSidebar({
  ...
  return (
    <>
      ...
      <div className={`bg-[#2d1b4e] border-r border-[#7B3FF2]/30 flex flex-col transition-all duration-300 ease-in-out h-full flex-shrink-0 overflow-hidden ${
        ...
        <div className="flex flex-col items-center border-b border-[#7B3FF2]/20">
          ...
          {/* Brain Logo - Hidden in Collapsed State */}
          {!isCollapsed && (
        ...
        {/* Lens Switcher - Admin Only - Hidden in Collapsed State */}
        ...
        {!isCollapsed && (
          <div className="p-4 border-b border-[#7B3FF2]/20">
            <button
              ...
              className="w-full px-4 py-2 bg-[#7B3FF2] hover:bg-[#6B46C1] text-white rounded-lg transition-colors flex items-center justify-center gap-2"
            >
        ...
        {/* Content Separators - Hidden in Collapsed */}
        {!isCollapsed && (
          <>
            {/* Mode Filter */}
        ...
        {/* Conversations List - Expanded View Only */}
        {!isCollapsed && (
